...
namespace FastFile
{
    ...
    public class FastFileInfo
    {
        ...
        internal FastFileInfo(String dir, WIN32_FIND_DATA findData)
        {
            ...
            this.CreationTimeUtc = ConvertDateTimeUtc(findData.ftCreationTime_dwHighDateTime, findData.ftCreationTime_dwLowDateTime);
            this.LastAccessTimeUtc = ConvertDateTimeUtc(findData.ftLastAccessTime_dwHighDateTime, findData.ftLastAccessTime_dwLowDateTime);
            this.LastWriteTimeUtc = ConvertDateTimeUtc(findData.ftLastWriteTime_dwHighDateTime, findData.ftLastWriteTime_dwLowDateTime);
        ...
        public class FileEnumerator : IEnumerator<FastFileInfo>
        {
            ...
            public FileEnumerator(String initialFolder, String searchFilter, SearchOption searchOption, IFolderFilter folderFilter)
            {
            ...
            public FileEnumerator(String initialFolder, String searchFilter, SearchOption searchOption, IFolderFilter folderFilter, bool basicInfoOnly, bool caseSensitive, bool largeBuffer)
            {
                init(initialFolder, searchFilter, searchOption, folderFilter);
                useEx = true;
